...
const Category = () => {
    ...
    const data = useSelector((state: RootState) => state.store.data); // Access updated Redux state
    const { design } = data || {};
    const catdata = useSelector((state: RootState) => state.myCategory.data); // Access updated Redux state
    const { category, subcategory, menu } = catdata || {};
        ...
        <nav>
            ...
            <ul className="lg:flex lg:flex-row lg:gap-10 lg:justify-center  ">
                ...
                <li className="relative group menu-seven py-7 flex items-center  justify-between">
                    <Link
                        href=""
                        className="menu-border font-bold text-sm menu-hover"
                    >
                        <h1>
                            Pages{' '}
                            <span>
