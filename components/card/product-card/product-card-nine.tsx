          ...
          <Link href={"/product/" + item?.id + "/" + item?.slug}>
            <div className="xl:h-[520px] lg:h-[520px]">
              <img
                ...
                alt="Mountain"
                className="block object-cover object-center h-auto xl:h-[600px] lg:h-[600px] w-[100%] ml-auto mr-auto  group-hover:scale-105 transition-all duration-300 ease-linear image"
              />
            </div>
...
export default ProductCardNine;
