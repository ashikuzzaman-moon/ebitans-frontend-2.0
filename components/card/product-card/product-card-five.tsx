...
const ProductCardFive = ({ item }: any) => {
    const overlyImage = `
    .image{
        transition: .5s ease;
    ...
    return (
        <div className="bg-gray-200 group w-full xl:h-[600px] lg:h-[500px] relative overflow-hidden mainContainer">
                    ...
                    <Link href={'/product/' + item?.id + '/' + item?.slug}>
                        <div className="xl:h-[520px] lg:h-[520px]">
                            <img
                                ...
                                alt="Mountain"
                                className="block object-cover object-center h-auto min-w-full xl:h-[600px] lg:h-[500px] group-hover:scale-105 transition-all duration-300 ease-linear image"
                            />
                        </div>

                        <div className=" ml-4 mr-4 my-5 lg:my-5 xl:justify-between md:justify-between lg:justify-between lg:absolute top-5 left-5 duration-1000 lg:opacity-0 lg:group-hover:opacity-100">
                            <div>
                                <p
